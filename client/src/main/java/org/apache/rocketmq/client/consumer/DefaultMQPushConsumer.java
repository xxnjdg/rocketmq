...
public class DefaultMQPushConsumer extends ClientConfig implements MQPushConsumer {
     ...
     * 如果从消息进度服务 OffsetStore 读取到 MessageQueue 中的偏移量不小于 0 ，则
     ...
     * 就是每次传入 M巳ssageListten巳r#consum巳Message 中 的消息条数
     */
     ...
     * if null or * expression,meaning subscribe all 消息过滤表达式， TAG 或 SQL92 表达式 。
     * @throws MQClientException if there is any client error.
     */
    @Override
